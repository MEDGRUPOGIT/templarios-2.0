...
export const tpCheckboxOuterBorderWidthOs: {
  original: string;
  number: number;
  decimal: number;
  scale: number;
...
export const tpCheckboxFontMapOs: {
  fontWeight: string;
  fontSize: {
    original: string;
    number: number;
...
export const tpInputBorderWidthOs: {
  original: string;
  number: number;
  decimal: number;
  scale: number;
...
export const tpSelectContentItemGapOs: {
  original: string;
  number: number;
  decimal: number;
  scale: number;
};
export const tpSelectContentItemMinHeightOs: {
  original: string;
  number: number;
  decimal: number;
  scale: number;
...
export const tpUiContentPaddingBottomOs: {
  original: string;
  number: number;
  decimal: number;
  scale: number;
