const S = {};
var L = /* @__PURE__ */ ((l) => (l.SUCCESS = "success", l.DANGER = "danger", l.WARNING = "warning", l.INFO = "info", l.PRIMARY = "primary", l.NEUTRAL_SOLID_500 = "neutral-solid-500", l))(L || {});
const t = {
  "tp-color": Object.values(L)
};
var _ = /* @__PURE__ */ ((l) => (l.SOLID = "solid", l.CLEAR = "clear", l))(_ || {}), a = /* @__PURE__ */ ((l) => (l.BUTTON = "button", l.BUTTON_ICON = "button-icon", l))(a || {});
const b = {
